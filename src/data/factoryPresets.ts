...
export const FACTORY_PRESETS: FactoryPreset[] = [
  ...
  },
  {
    id: 'factory-gameboy',
    name: 'GameBoy',
    description: '4-color green · 160×144 native',
    thumbnailColors: ['#0f380f', '#306230', '#8bac0f', '#9bbc0f'],
    settings: make({
      width: 160,
      height: 144,
  ...
  },
  {
    id: 'factory-minimal',
    name: '2-bit Minimal',
    description: '4 colors · heavy Bayer dither',
    thumbnailColors: ['#000000', '#555555', '#aaaaaa', '#ffffff'],
    settings: make({
      width: 128,
      height: 128,
      lockAspect: true,
